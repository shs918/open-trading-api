...
kis_api/kis_auth.py의 인증/호출 기능을 활용하여,
...
# kis_api 경로를 sys.path에 추가하여 kis_auth import 가능하게 함
_KIS_API_DIR = str(Path(__file__).parent.parent.parent / "kis_api")
if _KIS_API_DIR not in sys.path:
    sys.path.insert(0, _KIS_API_DIR)
